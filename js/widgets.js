...
$(document).ready(function () {
  ...
  var barchartOptions = {
    ...
    colors: [$danger, $danger_light, $warning],
    stroke: {
      show: true,
      width: 0,
      colors: ['transparent']
    ...
    series: [{
      name: 'Building A',
      data: [20, 80, 50, 80, 20, 39, 33, 29, 22, 63, 57, 30]
    }, {
      name: 'Building B',
      data: [60, 50, 21, 20, 22, 32, 70, 40, 30, 27, 21, 11]
    }, {
      name: 'Building C',
      data: [30, 20, 51, 60, 42, 12, 57, 20, 35, 37, 39, 21]
    }],
    xaxis: {
